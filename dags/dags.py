...
with DAG( dag_id = 'House_prices_ETL',description = 'DAG tht make etl' , schedule = '@daily',start_date=datetime(2024,4,1),end_date=datetime(2024,4,20),
    ...
    satrt_message = BashOperator( task_id = 'start_message', bash_command = 'sleep 15 && echo "ETL starting"')
